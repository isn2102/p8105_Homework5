...
Now do iteration. Going straight to a map, not doing the intermediate step of creating a for loop. In this case map takes pair of input columns (hom_unsolved and hom_total), outputs a column (prop_tests) which is added to the dataframe. Pull prop_tests column to check it. 
```{r}
aggregate_df %>% 
  mutate(
